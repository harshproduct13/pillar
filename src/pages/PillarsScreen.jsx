...
function CoachSection({ coach }) {
  ...
  return (
    <div className="mb-10">
      ...
      {/* Start Session label + cards */}
      <div className="flex items-stretch gap-3 overflow-x-auto scrollbar-hide pl-5 pr-5 pb-2">
        {/* Label card */}
        <div
          className="flex-shrink-0 w-16 h-52 rounded-3xl flex items-center justify-center"
    ...
    <div className="min-h-screen bg-dark-bg pb-28 overflow-x-hidden">
      ...
      <div className="mb-4">
        <div className="flex items-center gap-2 px-5 mb-5">
          <p className="text-[11px] font-bold text-dark-muted uppercase tracking-[0.12em]"> Your Coaches</p>
      ...
      <div>
        <div className="flex items-center gap-2 px-5 mb-5">
          <p className="text-[11px] font-bold text-dark-muted uppercase tracking-[0.12em]">Your Friends</p>
          <div className="flex-1 h-px bg-dark-border" />
        </div>
